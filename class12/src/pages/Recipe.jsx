    ...
    <div>
      ...
      <section className="my-4">
        <h1 className="my-2 flex items-center text-3xl gap-2 momo-trust-display-regular">
          <Waypoints /> Follow the steps to make this dish
        </h1>
          ...
          {Array.isArray(recipe.instructions)
            ? recipe.instructions.map((step, i) => (
                <div key={i} className="my-4">
                  ...
                  <span className="caveat-500 text-3xl">{step}</span>
                </div>
              ))
            : recipe.steps
                ?.split("\n")
                .map((line, i) => (
                  <div key={i} className="my-4">
                    ...
                    <span className="caveat-500 text-3xl">{line}</span>
                  </div>
                ))}
        </div>
      </section>
